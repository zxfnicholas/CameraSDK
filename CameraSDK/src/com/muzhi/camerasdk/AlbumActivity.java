...
public class AlbumActivity extends BaseActivity implements OnItemClickListener {
	...
	private TextView actionbarTitle,button_cancel;
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.camerasdk_activity_album);
		...
		actionbarTitle.setText(MResource.getIdByName(getApplication(),MResource.string,"camerasdk_album"));
