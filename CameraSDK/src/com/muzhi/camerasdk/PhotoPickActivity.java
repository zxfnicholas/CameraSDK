...
import com.muzhi.camerasdk.adapter.AlbumGridViewAdapter;
...
public class PhotoPickActivity extends BaseActivity {
	...
	private TextView button_complate,button_ablum,button_cancel;
	...
	private void initView(){
		...
		imageLocation = (TextView) findViewById(MResource.getIdByName(getApplication(),MResource.id,"imageLocation"));
		...
		button_ablum = (TextView) findViewById(MResource.getIdByName(getApplication(),MResource.id,"ablum_button"));
		button_cancel = (TextView) findViewById(MResource.getIdByName(getApplication(),MResource.id,"cancel_button"));
	...
	private void init() {
		...
		if(!TextUtils.isEmpty(imgLocation)){
			imageLocation.setText(imgLocation);
		} else {
			int resid=MResource.getIdByName(this, MResource.id, "camerasdk_album_all");
			imageLocation.setText("相机胶卷");
		}
	...
	private void initSelectImage() {
		...
		for (final String path : selectedDataList) {
			ImageView imageView = (ImageView) LayoutInflater.from(PhotoPickActivity.this).inflate(R.layout.camerasdk_choose_imageview, selectedImageLayout, false);
