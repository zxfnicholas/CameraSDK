...
import com.muzhi.camerasdk.model.ImageItem;
...
public class AlbumHelper {
	...
	public ArrayList<String> getAllPhoto(){
		...
		Cursor cur = cr.query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, columns, null, null, orderBy + " DESC");
		...
		for (int i = 0; i < count; i++) {
			...
			int dataColumnIndex = cur.getColumnIndexOrThrow(MediaColumns.DATA);
			dataList.add(cur.getString(dataColumnIndex));
		}
		return dataList;
	}
