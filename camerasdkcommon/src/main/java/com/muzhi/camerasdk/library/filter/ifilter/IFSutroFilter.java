...
public class IFSutroFilter extends IFImageFilter {
    ...
    private void setRes(Context context) {
    	int resId1=MResource.getIdByName(context,MResource.drawable, "vignette_map");
    	int resId2=MResource.getIdByName(context,MResource.drawable, "sutro_metal");
    	int resId3=MResource.getIdByName(context,MResource.drawable, "soft_light");
    	int resId4=MResource.getIdByName(context,MResource.drawable, "sutro_edge_burn");
    	int resId5=MResource.getIdByName(context,MResource.drawable, "sutro_curves");
