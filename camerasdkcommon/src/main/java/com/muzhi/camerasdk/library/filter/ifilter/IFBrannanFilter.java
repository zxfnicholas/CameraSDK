...
public class IFBrannanFilter extends IFImageFilter {
    ...
    private void setRes(Context context) {
    	...
    	int resId1=MResource.getIdByName(context,MResource.drawable, "brannan_process");
    	int resId2=MResource.getIdByName(context,MResource.drawable, "brannan_blowout");
    	int resId3=MResource.getIdByName(context,MResource.drawable, "brannan_contrast");
    	int resId4=MResource.getIdByName(context,MResource.drawable, "brannan_luma");
    	int resId5=MResource.getIdByName(context,MResource.drawable, "brannan_screen");
