...
public class IFEarlybirdFilter extends IFImageFilter {
    ...
    private void setRes(Context context) {
    	...
    	int resId1=MResource.getIdByName(context,MResource.drawable, "earlybird_curves");
    	int resId2=MResource.getIdByName(context,MResource.drawable, "earlybird_overlay_map");
    	int resId3=MResource.getIdByName(context,MResource.drawable, "vignette_map");
    	int resId4=MResource.getIdByName(context,MResource.drawable, "earlybird_blowout");
    	int resId5=MResource.getIdByName(context,MResource.drawable, "earlybird_map");
