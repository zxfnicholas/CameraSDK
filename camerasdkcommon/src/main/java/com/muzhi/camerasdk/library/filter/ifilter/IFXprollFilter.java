...
public class IFXprollFilter extends IFImageFilter {
    ...
    public IFXprollFilter(Context context) {
    ...
    private void setRes(Context context) {
    	...
    	int resId1=MResource.getIdByName(context,MResource.drawable, "xpro_map");
    	int resId2=MResource.getIdByName(context,MResource.drawable, "vignette_map");
