...
public class OperateUtils
{
	...
	private int resId_edit_del,resId_edit_control;
	...
	public OperateUtils(Activity activity){
		...
		resId_edit_del=MResource.getIdByName(activity,MResource.drawable, "camerasdk_edit_del");
		resId_edit_control=MResource.getIdByName(activity,MResource.drawable, "camerasdk_edit_control");
	}
	...
	public TextObject getTextObject(String text){
		...
		Bitmap rotateBm = BitmapFactory.decodeResource(activity.getResources(),resId_edit_control);
		Bitmap deleteBm = BitmapFactory.decodeResource(activity.getResources(),resId_edit_del);
